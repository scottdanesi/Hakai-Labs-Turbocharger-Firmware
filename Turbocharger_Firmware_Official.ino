/*
Completed Features:
- Internal RPM Adjustable with potentiometer
- Internal RPM Pulse Width (AFR) with potentiometer
- First draft for the detonation logic
- Gate resets cycle of the internal RPM
- Smoother Transition from low internal frequencies to higher

Todo:
- Tune glitch frequencies
- Tune glitch density
-
*/
...
///////////////////////////////////////////////////////////////////////////////////////////
// RPM LUT for the potentiometer curve.  This was generated by the code below:
///////////////////////////////////////////////////////////////////////////////////////////
/*
#include <stdio.h>
#include <math.h>
...
#define RPM_LUT_SIZE 256
#define POW_FLOAT 0.25 // For tuning, 0.25 works well

int main() {
    printf("const float rpm_lookup_table[%d] = {\n    ", RPM_LUT_SIZE);
    for (int i = 0; i < RPM_LUT_SIZE; i++) {
        float x = (float)i / (RPM_LUT_SIZE - 1);
        float y = pow(x, POW_FLOAT);
        printf("%.6ff", y); // Increased precision for the table values
        if (i < RPM_LUT_SIZE - 1) {
            printf(", ");
            if ((i + 1) % 8 == 0) {
                printf("\n    ");
...
*/
///////////////////////////////////////////////////////////////////////////////////////////
/*const float rpm_lookup_table[256] = {
	0.000000f, 0.250245f, 0.297593f, 0.329341f, 0.353900f, 0.374203f, 0.391654f, 0.407042f,
	0.420860f, 0.433437f, 0.445005f, 0.455736f, 0.465758f, 0.475172f, 0.484058f, 0.492479f,
	0.500489f, 0.508133f, 0.515446f, 0.522460f, 0.529203f, 0.535698f, 0.541964f, 0.548021f,
	0.553883f, 0.559564f, 0.565078f, 0.570435f, 0.575645f, 0.580717f, 0.585660f, 0.590480f,
	0.595186f, 0.599782f, 0.604275f, 0.608670f, 0.612972f, 0.617185f, 0.621314f, 0.625361f,
	0.629332f, 0.633229f, 0.637056f, 0.640814f, 0.644508f, 0.648139f, 0.651710f, 0.655223f,
	0.658681f, 0.662085f, 0.665438f, 0.668740f, 0.671995f, 0.675202f, 0.678365f, 0.681484f,
	0.684561f, 0.687596f, 0.690593f, 0.693550f, 0.696471f, 0.699355f, 0.702203f, 0.705018f,
	0.707799f, 0.710548f, 0.713265f, 0.715952f, 0.718608f, 0.721236f, 0.723835f, 0.726406f,
	0.728951f, 0.731469f, 0.733961f, 0.736428f, 0.738871f, 0.741289f, 0.743684f, 0.746056f,
	0.748406f, 0.750734f, 0.753041f, 0.755326f, 0.757591f, 0.759836f, 0.762061f, 0.764266f,
	0.766453f, 0.768621f, 0.770771f, 0.772904f, 0.775018f, 0.777116f, 0.779196f, 0.781260f,
	0.783308f, 0.785340f, 0.787357f, 0.789358f, 0.791343f, 0.793314f, 0.795271f, 0.797213f,
	0.799141f, 0.801055f, 0.802955f, 0.804842f, 0.806716f, 0.808577f, 0.810426f, 0.812261f,
	0.814084f, 0.815896f, 0.817695f, 0.819482f, 0.821258f, 0.823022f, 0.824775f, 0.826517f,
	0.828248f, 0.829968f, 0.831677f, 0.833376f, 0.835065f, 0.836744f, 0.838412f, 0.840071f,
	0.841720f, 0.843359f, 0.844989f, 0.846609f, 0.848220f, 0.849822f, 0.851415f, 0.852999f,
	0.854574f, 0.856141f, 0.857699f, 0.859248f, 0.860790f, 0.862323f, 0.863847f, 0.865364f,
	0.866873f, 0.868374f, 0.869868f, 0.871353f, 0.872831f, 0.874302f, 0.875765f, 0.877221f,
	0.878670f, 0.880112f, 0.881546f, 0.882974f, 0.884395f, 0.885809f, 0.887216f, 0.888616f,
	0.890010f, 0.891398f, 0.892778f, 0.894153f, 0.895521f, 0.896883f, 0.898239f, 0.899589f,
	0.900933f, 0.902270f, 0.903602f, 0.904928f, 0.906248f, 0.907562f, 0.908871f, 0.910174f,
	0.911472f, 0.912764f, 0.914050f, 0.915331f, 0.916607f, 0.917877f, 0.919142f, 0.920402f,
	0.921657f, 0.922907f, 0.924152f, 0.925391f, 0.926626f, 0.927856f, 0.929081f, 0.930301f,
	0.931516f, 0.932726f, 0.933932f, 0.935134f, 0.936330f, 0.937522f, 0.938710f, 0.939893f,
	0.941071f, 0.942245f, 0.943415f, 0.944580f, 0.945742f, 0.946898f, 0.948051f, 0.949200f,
	0.950344f, 0.951484f, 0.952620f, 0.953752f, 0.954880f, 0.956004f, 0.957124f, 0.958241f,
	0.959353f, 0.960461f, 0.961566f, 0.962667f, 0.963764f, 0.964857f, 0.965947f, 0.967033f,
	0.968115f, 0.969194f, 0.970269f, 0.971340f, 0.972408f, 0.973473f, 0.974534f, 0.975591f,
	0.976645f, 0.977696f, 0.978744f, 0.979788f, 0.980828f, 0.981866f, 0.982900f, 0.983931f,
	0.984958f, 0.985983f, 0.987004f, 0.988022f, 0.989037f, 0.990049f, 0.991057f, 0.992063f,
	0.993065f, 0.994065f, 0.995062f, 0.996055f, 0.997046f, 0.998033f, 0.999018f, 1.000000f
};*/
...
// Debugging Variables
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//bool debug_rpm_pot = false;
//bool debug_afr_pot = false;
//bool debug_det_pot = false;

//debounce variables
//uint8_t debounce_counter = 0;
//bool last_stable_status = false; // Store the last stable state
...
// adc_read_averaged() replaced by per-channel running sums inside each
// update function — O(1) instead of iterating all ADC_SAMPLES each call.

/*float update_internal_rpm_pot_value(void) {
	float adc_value = adc_read_averaged(ADC_MUXPOS_AIN1_gc, rpm_buffer, &rpm_index, &rpm_average);
	if (adc_value > 1.0) {
		adc_value = 1.0;
	}
	if (adc_value < 0.001) {
	...
	//rpm_value = 1.0f - pow(adc_value, 0.25);
	rpm_value = 1.0f - (adc_value, 0.25f);
	return 1;
}*/
...
/*float update_internal_rpm_pot_value(void) {
	...
	if (adc_value < 0.0f) adc_value = 0.0f; // Changed 0.001 to 0.0 for LUT indexing

	// Scale the ADC value (0.0-1.0) to the index range of the LUT (0-255)
	uint16_t index = (uint16_t)(adc_value * (RPM_LUT_SIZE - 1));

	// Ensure the index is within the valid range (shouldn't be necessary with the checks above)
	if (index >= RPM_LUT_SIZE) {
		index = RPM_LUT_SIZE - 1;
	}

	// The lookup table contains pow(adc_value, 0.25), so we still need to do 1.0 - result
	rpm_value = 1.0f - rpm_lookup_table[index];
